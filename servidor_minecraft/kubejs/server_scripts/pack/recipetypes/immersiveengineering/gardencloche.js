onEvent('recipes', (event) => {
  ...
  const seedsTier2 = ['mysticalagriculture:sulfur_seeds', 'mysticalagriculture:saltpeter_seeds', 'mysticalagriculture:obsidian_seeds', 'mysticalagriculture:nether_seeds', 'mysticalagriculture:nature_seeds', 'mysticalagriculture:end_seeds', 'mysticalagriculture:amethyst_seeds'];
