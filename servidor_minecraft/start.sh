...
#   https://github.com/Griefed/ServerPackCreator/blob/6.3.11/serverpackcreator-api/src/jvmMain/resources/de/griefed/resources/server_files/default_template.sh
#
...
echo "Start script generated by ServerPackCreator 6.3.11."
